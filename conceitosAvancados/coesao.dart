/* 
  ...
  exemplo
  uma classe RelatorioPDF deve gerar PDF e não cuidar da autenticação do usuário exemplo de coesão baixa (má pratica)
 */

class RelatorioBaguncado{
  void gerarPDF() => print("Gerando PDF");

  void autenticar() => print("Autenticando...");

  void enviarEmail() => print("enviando e-mail");
}
